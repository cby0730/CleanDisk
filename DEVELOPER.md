...
- 支援 4 種量化模型 (4-bit/8-bit)：
  - **Sky-High Hermes**: 平衡速度與精準度（推薦）
  - **Thinking 2507**: 深度推理，最精準但較慢
- 實作 Prompt Engineering 引導模型輸出 JSON 格式
- **JSON 解析優化**：
  - 自動移除 Thinking 模型的 `<think>...</think>` 標籤
...
| 模型 | 大小 | 速度 | 特性 |
|------|------|------|------|
| Qwen3 Sky-High Hermes 4bit | 2.3 GB | ⚡⚡⚡⚡⚡ | 快速且平衡（預設） |
| Qwen3 Sky-High Hermes 8bit | 4.3 GB | ⚡⚡⚡⚡ | 高精準度 |
| Qwen3 Thinking 2507 4bit | 2.3 GB | ⚡⚡⚡ | 深度推理 |
| Qwen3 Thinking 2507 8bit | 4.3 GB | ⚡⚡ | 最高精準度 |
